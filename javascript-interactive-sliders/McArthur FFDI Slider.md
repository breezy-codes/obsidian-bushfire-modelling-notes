...
resultTitle.textContent="Resultant McArthur Forest Fire Danger Index";
...
resultValue.style.marginTop="4px"; resultValue.textContent="—";
...
function update(fromPreset=false){
  ...
  resultValue.textContent = fmt(ffdi);

  // classification
  let cat="";
  if(ffdi<12) cat="Low–Moderate";
  else if(ffdi<25) cat="High";
  else if(ffdi<50) cat="Very High";
  else if(ffdi<75) cat="Severe";
  else if(ffdi<100) cat="Extreme";
  else cat="Catastrophic";
